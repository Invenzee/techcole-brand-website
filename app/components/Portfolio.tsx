...
export default function Portfolio() {
    return (
        <section className="w-full bg-white py-24 overflow-hidden relative z-20">
            <div className="max-w-[1300px] mx-auto px-6 mb-16 flex flex-col md:flex-row items-end justify-between gap-8">
                <div>
...
function PortfolioCard({ item }: { item: typeof portfolioItems[0] }) {
    return (
        <div className="relative w-[450px] h-[400px] rounded-3xl overflow-hidden group cursor-pointer bg-gray-100 flex-shrink-0">
